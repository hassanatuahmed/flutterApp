    ...
    for (var course in courseSections) {
      cards.add(
          Padding(
             ...
             child: Text("No more Sections to view, look\nfor more in our courses",
            ...
            body: SingleChildScrollView(
              child: Column(
                children: [
                  Stack(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          padding: EdgeInsets.only(top:12.5,bottom: 13.5,left: 20.0,right:14.0),
                          decoration: BoxDecoration(
                            color: Colors.white,
                  ...
                  Padding(
                    padding: EdgeInsets.only(right: 28,top: 28.0,left: 28.0),
                    child: Row(
